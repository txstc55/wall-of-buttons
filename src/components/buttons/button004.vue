<template>
  <div class="container">
    <a href="#" onclick="return false;" class="button button--piyo">
...
.button--hoo .button__wrapper::after {
  ...
  background: var(--sub_color1);
  clip-path: path(
    "M75.96,41.27l-42.76,11.17V0H0V100H33.2v-28.75l45.07-23.97c3.38-1.8,1.39-6.98-2.31-6.01Z"
  );
}
.button--hoo .button__wrapper::before {
  left: 6px;
